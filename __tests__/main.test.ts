...
jest.mock('../src/checkclc')
const mockedGetClas = mocked(getclcs)
...
describe('Pull request event', () => {
  ...
  test('the checkclc  method should not called if there is a pull request merge/closed', async () => {
    await run()
  ...
  test('the checkclc  method should  be called if there is a pull request opened', async () => {
    github.context.payload.action = 'opened'
    await run()
  ...
  test('the checkclc  method should  be called if there is a pull request sync', async () => {
    github.context.payload.action = 'synchronize'
    await run()
    expect(mockedGetClas).toHaveBeenCalled()
  })
